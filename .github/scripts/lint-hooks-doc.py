...
can't judge free-form claims (e.g. "deliberately NOT extended to X") — only the mechanical facts
above, which is what has actually drifted every time so far. Exit 0 = clean or nothing to
